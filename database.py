...
def create_database():
    ...
    facts = [
        ...
        ("Разные концовки", "В Undertale есть три основных концовки: Нейтральная, Пацифистская и Геноцидная.", 1, 300,
         80, None, 1),
        (
        "Ральзей = Эйзриэль", "Теория: Ральзей из Deltarune — это Эйзриэль из Undertale, упавший в Темный Мир.", 1, 500,
        60, None, 1),
        ...
        # Уровень 3 (Y + 200)
        (
        "Entry Number 17", "Таинственная запись #17 в лаборатории связана с экспериментами Гастера.", 3, 320, 550, None,
        1),
        ...
        ("96 концовок",
         ...
         720, None, 1),
        (
        "DARKER YET DARKER", "Фраза 'DARKER YET DARKER' связана с экспериментами Гастера в пустоте.", 4, 420, 750, None,
        1),
        ...
        # Уровень 5 (Y + 200)
        (
        "666 комната", "В файлах игры есть скрытая комната с необычным содержимым (sound_test).", 5, 360, 820, None, 1),
        ("Следователи Гастера",
        ...
        ("Поисковый отряд Десс",
         "После исчезновения Десс был организован поисковый отряд. Санс и Папирус участвовали в поисках.", 6, 550, 1080,
         None, 1),
        ...
        ("Рыцарь — Герой?",
         ...
         9, 150, 1350, None, 1),
        ("Десс стала Фонтаном",
         "Десс не погибла, а сама стала живым Темным Фонтаном или его сердцевиной, питая энергией миры Темнеров.",
         9, 480, 1480, None, 1),
        ("Третья сущность",
